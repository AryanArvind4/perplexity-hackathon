        ...
        <>
            ...
            <main className="pt-[72px] font-sans text-black w-full overflow-hidden">
                ...
                <section id="home" className="relative w-full min-h-screen">
                    ...
                    <div className="relative z-10 container mx-auto px-4 flex justify-center items-center min-h-screen">
                        <h2 className="text-white text-4xl md:text-5xl font-extrabold text-center">Lights Camera... Vacation</h2>
                    </div>
                </section>

                {/* Features Section */}
                <section id="features" className="py-20 bg-black text-white">
                    <div className="w-full max-w-7xl mx-auto px-4 py-3 flex items-center justify-between flex-wrap">
                ...
                {/* Search Section */}
                <section id="search" className="py-20 bg-gray-100 text-black">
                    <div className="w-full max-w-7xl mx-auto px-4 py-3 flex items-center justify-between flex-wrap">
                ...
                {/* Itinerary Section */}
                <section id="itinerary" className="py-20 bg-gradient-to-b from-white to-blue-50 text-black">
                    <div className="w-full max-w-7xl mx-auto px-4 py-3 flex items-center justify-between flex-wrap">
                        ...
                        {itinerary ? (
                            ...
                            <div className="max-w-none mx-auto text-center bg-white rounded-lg p-6 shadow-lg">
                                <p className="text-gray-500">No itinerary generated yet. Please fill out the form above.</p>
                            </div>
                        )}
                    </div>
                </section>
